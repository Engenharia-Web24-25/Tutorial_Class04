    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          View(await _context.Category.Include(c=>c.Courses).ToListAsync()) :
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,State,Date")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
